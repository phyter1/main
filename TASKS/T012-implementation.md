...
1. **Extracted System Prompt Constant**
   - Created `REMOVED_FROM_HISTORY` constant containing the full system prompt
...
2. **Added Prompt Loading Function**
   ...
   - Falls back to `REMOVED_FROM_HISTORY` on error or no active version
...
- [x] **Functionality**: All acceptance criteria met
  - System prompt extracted to `REMOVED_FROM_HISTORY`
